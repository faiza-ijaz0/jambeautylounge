    ...
    <footer className="bg-primary text-white py-40 px-4 border-t border-white/5 relative overflow-hidden mt-20">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24">
          ...
          <div className="space-y-12">
            <h4 className="font-black uppercase tracking-[0.5em] text-[10px] text-gray-400">The Menu</h4>
          ...
          <div className="space-y-12">
            <h4 className="font-black uppercase tracking-[0.5em] text-[10px] text-gray-500">Global Reach</h4>
            <div className="space-y-4">
              {[
                ...
                <div key={s.label} className="flex items-end justify-between border-b border-white/5 pb-4">
                  ...
                  <span className="font-serif italic text-2xl text-gray-500">{s.count}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-12">
            <h4 className="font-black uppercase tracking-[0.5em] text-[10px] text-gray-500">Concierge</h4>
            <ul className="space-y-10 text-white/70 text-sm font-light">
              <li className="flex items-start gap-5 group">
                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-gray-500 group-hover:bg-secondary group-hover:text-white transition-all duration-700 shadow-xl border border-white/5">
