...
//       if (freshData.paymentMethods && freshData.paymentMethods.length > 0 && freshData.paymentAmounts) {
//         freshData.paymentMethods.forEach(method => {
//           const amount = freshData.paymentAmounts?.[method] || 0;
//           if (amount > 0) {
//             paymentMethods.push({
//               type: method,
//               label: paymentLabels[method] || method,
//               amount: amount,
//               details: method === 'card' ? `Card ending in ${freshData.cardLast4Digits || '****'}` : ''
//             });
//           }
//         });
//       }
...
//       const taxAmount = (subtotal * initialInvoice.tax) / 100;
//       const totalAmount = subtotal + taxAmount + initialInvoice.serviceCharges - 
//                          (initialInvoice.discountType === 'fixed' ? initialInvoice.discount : 
//                           (subtotal * initialInvoice.discount / 100)) + initialInvoice.serviceTip;
...
//                   <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 border rounded-lg">
//                     <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//                       <div className="text-center">
//                         <p className="text-sm text-gray-600">Total Amount</p>
//                         <p className="text-2xl font-bold text-blue-700">
...
//                 <div className="flex justify-between items-center text-xl font-bold p-3 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg">
//                   <div className="flex items-center gap-2">
...
//                     {formatCurrency(
//                       displayAppointment.totalAmount ||
//                       displayAppointment.price ||
//                       displayAppointment.servicePrice ||
//                       0
//                     )}
//                   </span>
//                 </div>
