...
export default function OrderFinanceReportPage() {
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `order-finance-report-AED {format(new Date(), 'yyyy-MM-dd')}.csv`;
    a.click();
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                AED  {summary.totalOrders} orders
                </p>
              </CardContent>
            </Card>
                          ...
                          {(() => {
                            ...
                            filteredOrders.forEach(order => {
                              order.products.forEach(product => {
                                const key = `AED {product.productName}|AED {product.productCategory}`;
