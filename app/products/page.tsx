...
//   // Agar user logged in nahi hai, directly checkout pe redirect karo
//   // Kyunki aap chahte hain ke login na kare bhi checkout page dekh sake
//   if (!authData) {
//     // FIRST add product to local storage (without login)
...
//     // Redirect to checkout page (no login required)
